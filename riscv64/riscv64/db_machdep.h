...
#ifndef	_RISCV64_DB_MACHDEP_H_
#define	_RISCV64_DB_MACHDEP_H_
...
#include <riscv64/thread.h>		/* for thread_status */
#include <riscv64/trap.h>

typedef	vm_offset_t	db_addr_t;	/* address - unsigned */
typedef	long		db_expr_t;	/* expression - signed */

typedef struct riscv64_saved_state db_regs_t;

 ...
 */
#ifndef _RISCV64_KERNEL_RISCV64_VM_PARAM_
#define _RISCV64_KERNEL_RISCV64_VM_PARAM_
...
#define KERNEL_STACK_SIZE	(4*RISCV64_PGBYTES)
#define INTSTACK_SIZE		(4*RISCV64_PGBYTES)
#else	/* MACH_PV_PAGETABLES */
#define KERNEL_STACK_SIZE	(1*RISCV64_PGBYTES)
#define INTSTACK_SIZE		(1*RISCV64_PGBYTES)
#endif	/* MACH_PV_PAGETABLES */
...
#endif /* _RISCV64_KERNEL_RISCV64_VM_PARAM_ */
